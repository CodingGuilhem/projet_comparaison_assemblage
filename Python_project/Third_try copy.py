...
final = final_task("Test_sequence/assemblage_test/reference/rice.fasta","Test_sequence/assemblage_test/besst_assemblage/rice/Scaffolds_pass1.fasta",100,"test2",graphics=True)
